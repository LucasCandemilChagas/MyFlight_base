...
public class App {
	public static void main(String[] args) {
		...
		Aeroporto aeroporto1 = new Aeroporto("SDU", "Santos-Dummont", new Geo(-21.4563, -43.5519));
		Aeroporto aeroporto2 = new Aeroporto("GRU", "Guarulhos", new Geo(23.4306, 46.4730));
		Aeroporto aeroporto3 = new Aeroporto("MIA", "Miami International Airport", new Geo(25.7933, -80.2906));
